...
class Config:
    def __init__(self):
        ...
        # KNN topology + edge gating (end-to-end)
        self.use_knn_topology = False
        self.object_knn = 20
        self.controller_knn = 30
        self.use_edge_gating = False
        self.k_base_from_rest_length = True
        self.edge_gate_init = 3.0
        self.k_base_scale = 1.0
        self.rest_length_clamp_min = 1e-4
